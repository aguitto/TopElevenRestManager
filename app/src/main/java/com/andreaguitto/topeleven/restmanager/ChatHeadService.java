package com.andreaguitto.topeleven.restmanager;
...
import com.andreaguitto.topeleven.R;
...
public class ChatHeadService extends Service {			
	...
	private void handleStart(){
		...
		removeView = (RelativeLayout)inflater.inflate(R.layout.layout_removeicon, null);
		...
		chatheadView = (RelativeLayout) inflater.inflate(R.layout.layout_chatoverlay_icon, null);
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				switch (event.getAction()) {
					...
					case MotionEvent.ACTION_UP:
						...
						if(inBounded){
							if(ChatOverlayActivity.active){
								ChatOverlayActivity.myDialog.finish();
							}
		...
		txtView = (LinearLayout)inflater.inflate(R.layout.layout_chatmessage, null);
	...
	private void chathead_click(){
		if(ChatOverlayActivity.active){
			...
			Intent it = new Intent(this,ChatOverlayActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
	        startActivity(it);
		}
